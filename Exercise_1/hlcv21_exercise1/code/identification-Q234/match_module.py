...
def show_neighbors(model_images, query_images, dist_type, hist_type, num_bins):
  ...
  for j in range(len(query_images)):
    ...
    plt.subplot(1,6,3)
    plt.imshow(Image.open(model_images[sorted_query_index[1]]))
    plt.subplot(1,6,4)
    plt.imshow(Image.open(model_images[sorted_query_index[2]]))
    plt.subplot(1,6,5)
    plt.imshow(Image.open(model_images[sorted_query_index[3]]))
    plt.subplot(1,6,6)
    plt.imshow(Image.open(model_images[sorted_query_index[4]]))
